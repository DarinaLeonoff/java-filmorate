...
public class FilmTest {
    ...
    void exceptionIfLongDescription() {
        Film film = new Film();
        film.setName("Title");
        film.setDescription("Lorem ipsum dolor sit amet consectetur adipiscing elit quisque faucibus ex sapien vitae " + "pellentesque sem placerat in id cursus mi. Lorem ipsum dolor sit amet consectetur adipiscing elit quisque faucibus ex sapien vitae pellentesque sem placerat in id cursus mi.");
        film.setReleaseDate(LocalDate.of(1999, 2, 28));
        film.setDuration(200);
    ...
    void exceptionIfNullReleaseDate() {
        ...
        Set<ConstraintViolation<Film>> violations = validator.validate(film);
        Assertions.assertFalse(violations.isEmpty());
        Assertions.assertTrue(violations.stream().anyMatch(v -> v.getMessage().equals("Не указана дата выхода фильма.")));
    }
