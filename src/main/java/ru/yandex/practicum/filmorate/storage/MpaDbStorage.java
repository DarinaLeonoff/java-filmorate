...
public class MpaDbStorage {
    private static final String GET_RATING = "SELECT * FROM films f LEFT JOIN mpa ON  f.rating_id = mpa.rating_id " + "WHERE film_id = :filmId;";
    ...
    public Mpa getFilmRating(Long filmId) {
        ...
        Mpa mpaRes = jdbc.queryForObject(GET_RATING, film, (rs, rowNum) -> {
            Mpa mpa = new Mpa();
    ...
    public List<Mpa> getAllRatings() {
        return jdbc.query(GET_RATINGS, (rs, rowNum) -> {
            Mpa mpa = new Mpa();
    ...
    public Mpa getById(Long id) {
        ...
        return jdbc.queryForObject(GET_RATING_BY_ID, mpaId, (rs, rowNum) -> {
            Mpa dto = new Mpa();
    ...
    public boolean isIdValid(Long id) {
        List<Long> ratings = jdbc.query(GET_RATINGS, (rs, rowNum) -> rs.getLong("rating_id"));
